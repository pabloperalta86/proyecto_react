...
const Cart = () => {
    ...
    const styles = {
        ...
        highlight: "font-medium text-xs text-gray-700 tracking-wider leading-loose",
                        ...
                        <table className="inline-block overflow-x-auto whitespace-nowrap">
                            ...
                            <thead className="h-10 text-center">
                                <tr className="border-gray-200 border-b">
                                    ...
                                    <th className={(styles.highlight) + " px-6 lg:px-16 xl:px-32"}>Precio</th>
                                    <th className={(styles.highlight) + " px-6 md:px-2 lg:px-8 xl:px-12"}>Cantidad</th>
                                    <th className={(styles.highlight) + " px-6 md:px-2 lg:px-16 xl:px-28"}>Subtotal</th>
                                    <th />
                                </tr>
                            </thead>
                                ...
                                {cartItems.map((item) => (
                                    <tr key={item.id} className="border-gray-200 border-b">
                                        <th className="flex flex-row justify-left items-center pr-40 md:pr-0">
                                            <img className="p-4 h-60" src={item.pictureUrl} alt={item.description} />
